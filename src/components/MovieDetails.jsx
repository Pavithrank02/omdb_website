        ...
        <div className='flex flex-row justify-between'>
          ...
          <div className='ml-3 mr-3 w-full justify-center'>
            <div className='p-1 h-16 mt-2 w-full bg-gray-500 border border-slate-400 flex flex-row align-center'>
              ...
              <p className='text-blue-800 text-xl ml-6'>{movieDetails.Director}</p>
            </div>
            <div className='p-1 h-16 mt-2 w-full bg-gray-500 border border-slate-400 flex flex-row align-center'>
              <p className='text-white text-xl ml-1'>Writers: </p>
              <p className='text-blue-800 text-xl ml-6'>{movieDetails.Writer}</p>
            </div>
            <div className='p-1 h-16 mt-2 w-full bg-gray-500 border border-slate-400 flex flex-row align-center'>
              <p className='text-white text-xl ml-1'>Stars: </p>
              <p className='text-blue-800 text-xl ml-6'>{movieDetails.Actors}</p>
            </div>
            <div className='p-1 h-16 mt-2 w-full bg-gray-500 border border-slate-400 flex flex-row align-center'>
              <p className='text-white text-xl ml-1'>Production: BoxOffice : Country </p>
              <p className='text-blue-800 text-xl ml-6'>{movieDetails.Production}: {movieDetails.BoxOffice}: {movieDetails.Country}</p>
            </div>
          </div>
